                ...
                <div class="col-sm-4">
                  <div class="panel panel-danger">
                    ...
                    <div class="panel-footer">
                        ...
                        <li><b>Responsibilities: </b><a href="{{url_for('frontend.show', page='movies.html')}}">Movies</a></li>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-success">
                    ...
                    <div class="panel-footer">
                        ...
                        <li><b>Responsibilities: </b><a href="{{url_for('frontend.show', page='characters.html')}}">Characters</a> and <a href="{{url_for('frontend.show', page='comicseries.html')}}">Comics</a></li>
